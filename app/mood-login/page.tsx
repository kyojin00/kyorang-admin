...
import { createMoodBrowserClient } from '@/lib/supabase-mood-browser';
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-black mb-2">교랑무드 관리자</h1>
...
function LoginForm() {
  ...
  const [error, setError] = useState<string | null>(
    errorParam === 'not_admin' ? '무드 관리자 권한이 없습니다' : null,
  );

  const supabase = createMoodBrowserClient();
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        >
          <div>
            ...
            <input
              ...
              placeholder="kyojin0527@kyorang.com"
            />
          </div>
        ...
        <p className="mt-2 text-center text-xs text-white/30">
          <a href="/login" className="hover:text-white/50 underline underline-offset-2">
            교랑톡 관리자 로그인 →
          </a>
        </p>
      </div>
